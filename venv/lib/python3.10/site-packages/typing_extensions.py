...
if hasattr(io, "Reader") and hasattr(io, "Writer"):
    ...
    class Reader(Protocol[T_co]):
        ...
        def read(self, size: int = ..., /) -> T_co:
            ...
            If *size* is specified, at most *size* item (bytes/characters) will be
            read.
            """
    ...
    class Writer(Protocol[T_contra]):
        ...
        def write(self, data: T_contra, /) -> int:
            """Write *data* to the output stream and return the number of item written."""  # noqa: E501
...
if _PEP_728_IMPLEMENTED:
    ...
    def TypedDict(self, args):
        ...
        the total argument. True is the default, and makes all item defined in the
...
# Aliases for item that are in typing in all supported versions.
