...
class ChoiceField(Field):
    ...
    html_cutoff = None
    html_cutoff_text = _('More than {count} item...')
...
class MultipleChoiceField(ChoiceField):
    default_error_messages = {
        'invalid_choice': _('"{input}" is not a valid choice.'),
        'not_a_list': _('Expected a list of item but got type "{input_type}".'),
...
class DictField(Field):
    ...
    initial = {}
    default_error_messages = {
        'not_a_dict': _('Expected a dictionary of item but got type "{input_type}".'),
