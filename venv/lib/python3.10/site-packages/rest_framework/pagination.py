...
class CursorPagination(BasePagination):
    ...
    def paginate_queryset(self, queryset, request, view=None):
        ...
        if reverse:
            ...
            # so we need to reverse the item again before returning them to the user.
    ...
    def get_next_link(self):
        ...
        if self.page and not has_item_with_unique_position:
            ...
            if not self.has_previous:
                ...
                # where we end up skipping forward a few extra item.
                offset = 0
    ...
    def get_previous_link(self):
        ...
        if self.page and not has_item_with_unique_position:
            ...
            if not self.has_next:
                ...
                # The change in direction will introduce a paging artifact,
                # where we end up skipping back a few extra item.
                offset = 0
                position = self.next_position
