...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _load_libtiff(self) -> Image.core.PixelAccess | None:
        ...
        if hasattr(self.fp, "getvalue"):
            ...
            #
            # Rearranging for supporting byteio item, since they have a fileno
...
def _save(im: Image.Image, fp: IO[bytes], filename: str | bytes) -> None:
    ...
    if libtiff:
        ...
        for tag, value in itertools.chain(ifd.items(), supplied_tags.items()):
            # Libtiff can only process certain core item without adding
            # them to the custom dictionary.
            # Custom item are supported for int, float, unicode, string and byte
        ...
        logger.debug("Converted item: %s", sorted(atts.items()))
