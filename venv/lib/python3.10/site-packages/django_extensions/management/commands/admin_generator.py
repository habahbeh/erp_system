...
models and automatically generate an Admin with properties like:
 ...
 - `list_filter` for foreign keys with few item
 - `raw_id_fields` for foreign keys with a lot of item
...
class Command(LabelCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help="If a foreign key has less than LIST_FILTER_THRESHOLD item "
        ...
        parser.add_argument(
            ...
            help="If a foreign key has more than RAW_ID_THRESHOLD item "
            "it will be added to `list_filter` [default: %(default)s]",
        )
