...
try:
    ...
    class OrderedDict(dict):
        ...
        def clear(self):
            'od.clear() -> None.  Remove all item from od.'
            try:
        ...
        def items(self):
            'od.item() -> list of (key, value) pairs in od'
        ...
        def iteritems(self):
            'od.iteritems -> an iterator over the (key, value) item in od'
            for k in self:
                yield (k, self[k])
        ...
        def update(*args, **kwds):
            ...
            Or if E is an iterable of item, does:   for k, v in E: od[k] = v
            In either case, this is followed by:     for k, v in F.item(): od[k] = v
        ...
        def viewitems(self):
            "od.viewitems() -> a set-like object providing a view on od's item"
