...
class Configuration:
    ...
    def items(self) -> Iterable[tuple[str, Any]]:
        """Returns key-value pairs like dict.item() representing the loaded
        configuration
        """
    ...
    def _normalized_keys(
        ...
        """Normalizes item to construct a dictionary with normalized keys.
    ...
    def iter_config_files(self) -> Iterable[tuple[Kind, list[str]]]:
        ...
        This should be treated like item of a dictionary. The order
