...
_MESSAGE_REPLACEMENTS = {
    ...
    "only specified item": "only item matching the definition",
}
...
_NEED_DETAILS = {"anyOf", "oneOf", "anyOf", "contains", "propertyNames", "not", "item"}
...
class _SummaryWriter:
    ...
    def __init__(self, jargon: Optional[Dict[str, str]] = None):
        ...
        self._terms = {
            ...
            "prefixItems": f"{self._jargon('item')} (in order)",
            "item": "item",
