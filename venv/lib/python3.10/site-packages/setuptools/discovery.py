...
class _Finder:
    ...
    def find(
        ...
        """Return a list of all Python item (packages or modules, depending on
        ...
        If it's specified, only the named item will be included.
        If it's not specified, all found item will be included.
