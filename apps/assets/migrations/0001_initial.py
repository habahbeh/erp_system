# Generated by Django 5.2.5 on 2025-10-17 06:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.ForeignKey(blank=True, limit_choices_to={'account_type__type_category': 'liabilities'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='supplied_assets', to='accounting.account', verbose_name='المورد')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.branch', verbose_name='الفرع')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.company', verbose_name='الشركة')),
                ('counterpart_account', models.ForeignKey(blank=True, help_text='مورد للشراء أو عميل للبيع', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='asset_transactions', to='accounting.account', verbose_name='الطرف الآخر')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL, verbose_name='أنشأ بواسطة')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.company', verbose_name='الشركة')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL, verbose_name='أنشأ بواسطة')),
                ('external_vendor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='asset_maintenances', to='accounting.account', verbose_name='المورد الخارجي')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calculated_at', models.DateTimeField(auto_now_add=True, verbose_name='تاريخ الاحتساب')),
                ('notes', models.TextField(blank=True, verbose_name='ملاحظات')),
                ...
                ('calculated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='calculated_depreciations', to=settings.AUTH_USER_MODEL, verbose_name='احتسب بواسطة')),
